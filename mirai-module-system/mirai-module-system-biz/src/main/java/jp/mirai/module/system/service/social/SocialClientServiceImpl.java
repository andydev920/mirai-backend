package jp.mirai.module.system.service.social;
...
import jp.mirai.framework.common.util.cache.CacheUtils;
import jp.mirai.framework.common.util.http.HttpUtils;
import jp.mirai.framework.common.util.object.BeanUtils;
import jp.mirai.module.system.api.social.dto.SocialWxQrcodeReqDTO;
import jp.mirai.module.system.api.social.dto.SocialWxaSubscribeMessageSendReqDTO;
import jp.mirai.module.system.controller.admin.socail.vo.client.SocialClientPageReqVO;
import jp.mirai.module.system.controller.admin.socail.vo.client.SocialClientSaveReqVO;
import jp.mirai.module.system.dal.dataobject.social.SocialClientDO;
import jp.mirai.module.system.dal.mysql.social.SocialClientMapper;
import jp.mirai.module.system.dal.redis.RedisKeyConstants;
...
import static jp.mirai.framework.common.util.collection.MapUtils.findAndThen;
import static jp.mirai.framework.common.util.json.JsonUtils.toJsonString;
...
public class SocialClientServiceImpl implements SocialClientService {
     ...
     * 3. developer：开发版
     */
    @Value("${mirai.wxa-code.env-version:release}")
     ...
     * 3. formal：正式版
     */
    @Value("${mirai.wxa-subscribe-message.miniprogram-state:formal}")
