package jp.mirai.module.system.controller.admin.user.vo.user;

import cn.hutool.core.util.ObjectUtil;
import jp.mirai.framework.common.validation.Mobile;
import jp.mirai.module.system.framework.operatelog.core.DeptParseFunction;
import jp.mirai.module.system.framework.operatelog.core.PostParseFunction;
import jp.mirai.module.system.framework.operatelog.core.SexParseFunction;
...
public class UserSaveReqVO {
    ...
    @Schema(description = "用户账号", requiredMode = Schema.RequiredMode.REQUIRED, example = "mirai")
    ...
    @Schema(description = "用户邮箱", example = "mirai@iocoder.cn")
