package jp.mirai.module.system.service.user;
...
import jp.mirai.framework.common.util.collection.ArrayUtils;
import jp.mirai.framework.common.util.collection.CollectionUtils;
import jp.mirai.framework.test.core.ut.BaseDbUnitTest;
import jp.mirai.module.infra.api.config.ConfigApi;
import jp.mirai.module.infra.api.file.FileApi;
...
import jp.mirai.module.system.controller.admin.user.vo.user.*;
import jp.mirai.module.system.dal.dataobject.dept.DeptDO;
import jp.mirai.module.system.dal.dataobject.dept.PostDO;
import jp.mirai.module.system.dal.dataobject.dept.UserPostDO;
import jp.mirai.module.system.dal.dataobject.tenant.TenantDO;
import jp.mirai.module.system.dal.dataobject.user.AdminUserDO;
import jp.mirai.module.system.dal.mysql.dept.UserPostMapper;
import jp.mirai.module.system.dal.mysql.user.AdminUserMapper;
import jp.mirai.module.system.enums.common.SexEnum;
...
import static jp.mirai.framework.common.util.collection.SetUtils.asSet;
...
import static jp.mirai.module.system.service.user.AdminUserServiceImpl.USER_INIT_PASSWORD_KEY;
...
public class AdminUserServiceImplTest extends BaseDbUnitTest {
    ...
    public void before() {
        // mock 初始化密码
        when(configApi.getConfigValueByKey(USER_INIT_PASSWORD_KEY)).thenReturn("miraiyuanma");
    }
    ...
    public void testCreatUser_success() {
        ...
        when(passwordEncoder.encode(eq(reqVO.getPassword()))).thenReturn("miraiyuanma");
        ...
        assertEquals("miraiyuanma", user.getPassword());
    ...
    public void testImportUserList_02() {
        ...
        when(deptService.getDept(eq(dept.getId()))).thenReturn(dept);
        // mock passwordEncoder 的方法
        when(passwordEncoder.encode(eq("miraiyuanma"))).thenReturn("java");
