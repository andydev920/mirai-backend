...
public class ProjectReactor {
    ...
    private static final String GROUP_ID = "jp.mirai";
    private static final String ARTIFACT_ID = "mirai";
    private static final String PACKAGE_NAME = "jp.mirai";
    private static final String TITLE = "みらいシステム";
    ...
    public static void main(String[] args) {
        ...
        // ========== 配置，需要你手动修改 ==========
        String groupIdNew = "jp.mirai";
        String artifactIdNew = "mirai";
        String packageNameNew = "jp.mirai";
        String titleNew = "みらいシステム";
