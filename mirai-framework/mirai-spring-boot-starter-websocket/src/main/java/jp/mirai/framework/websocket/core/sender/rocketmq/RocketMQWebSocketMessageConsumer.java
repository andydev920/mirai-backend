package jp.mirai.framework.websocket.core.sender.rocketmq;
...
@RocketMQMessageListener( // 重点：添加 @RocketMQMessageListener 注解，声明消费的 topic
        topic = "${mirai.websocket.sender-rocketmq.topic}",
        consumerGroup = "${mirai.websocket.sender-rocketmq.consumer-group}",
