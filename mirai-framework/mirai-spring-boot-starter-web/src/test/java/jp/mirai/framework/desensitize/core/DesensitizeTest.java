package jp.mirai.framework.desensitize.core;

import jp.mirai.framework.common.util.json.JsonUtils;
import jp.mirai.framework.desensitize.core.annotation.Address;
import jp.mirai.framework.desensitize.core.regex.annotation.EmailDesensitize;
import jp.mirai.framework.desensitize.core.regex.annotation.RegexDesensitize;
import jp.mirai.framework.desensitize.core.slider.annotation.*;
import lombok.Data;
...
public class DesensitizeTest {
    ...
    public void test() {
        ...
        desensitizeDemo.setNickname("mirai");
        ...
        desensitizeDemo.setRegex("你好，我是mirai");
        desensitizeDemo.setAddress("北京市海淀区上地十街10号");
        desensitizeDemo.setOrigin("mirai");
        ...
        assertEquals("mirai", d.getOrigin());
    }
    ...
    public static class DesensitizeDemo {
        ...
        @RegexDesensitize(regex = "mirai", replacer = "*")
