package jp.mirai.module.infra.service.codegen.inner;
...
import jp.mirai.framework.apilog.core.enums.OperateTypeEnum;
...
import jp.mirai.framework.common.util.date.DateUtils;
import jp.mirai.framework.common.util.date.LocalDateTimeUtils;
import jp.mirai.framework.common.util.object.BeanUtils;
import jp.mirai.framework.common.util.object.ObjectUtils;
import jp.mirai.framework.common.util.string.StrUtils;
import jp.mirai.framework.excel.core.annotations.DictFormat;
import jp.mirai.framework.excel.core.convert.DictConvert;
...
public class CodegenEngine {
    ...
    private static String javaModuleFilePath(String path, String module, String src) {
        return "mirai-module-${table.moduleName}/" + // 顶级模块
                "mirai-module-${table.moduleName}-" + module + "/" + // 子模块
                "src/" + src + "/java/${basePackage}/module/${table.moduleName}/" + path + ".java";
    }

    private static String mapperXmlFilePath() {
        return "mirai-module-${table.moduleName}/" + // 顶级模块
                "mirai-module-${table.moduleName}-biz/" + // 子模块
    ...
    private static String vueFilePath(String path) {
        return "mirai-ui-${sceneEnum.basePackage}-vue2/" + // 顶级目录
                "src/" + path;
    }
    ...
    private static String vue3FilePath(String path) {
        return "mirai-ui-${sceneEnum.basePackage}-vue3/" + // 顶级目录
                "src/" + path;
    }
