package jp.mirai.module.infra.controller.admin.logger.vo.apierrorlog;

import jp.mirai.framework.excel.core.annotations.DictFormat;
import jp.mirai.framework.excel.core.convert.DictConvert;
import jp.mirai.module.infra.enums.DictTypeConstants;
...
public class ApiErrorLogRespVO {
    ...
    @DictFormat(jp.mirai.module.system.enums.DictTypeConstants.USER_TYPE)
