package jp.mirai.module.infra.service.file;
...
import jp.mirai.module.infra.framework.file.core.enums.FileStorageEnum;
...
import jp.mirai.module.infra.dal.mysql.file.FileConfigMapper;
import lombok.Data;
...
import static jp.mirai.framework.test.core.util.RandomUtils.randomLongId;
import static jp.mirai.framework.test.core.util.RandomUtils.randomPojo;
import static jp.mirai.module.infra.enums.ErrorCodeConstants.FILE_CONFIG_DELETE_FAIL_MASTER;
import static jp.mirai.module.infra.enums.ErrorCodeConstants.FILE_CONFIG_NOT_EXISTS;
...
public class FileConfigServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetFileConfigPage() {
        // mock 数据
        FileConfigDO dbFileConfig = randomFileConfigDO().setName("mirai")
