package jp.mirai.module.infra.service.job;

import jp.mirai.framework.common.pojo.PageResult;
import jp.mirai.framework.test.core.ut.BaseDbUnitTest;
import jp.mirai.module.infra.controller.admin.job.vo.log.JobLogPageReqVO;
import jp.mirai.module.infra.dal.dataobject.job.JobLogDO;
import jp.mirai.module.infra.dal.mysql.job.JobLogMapper;
import jp.mirai.module.infra.enums.job.JobLogStatusEnum;
...
import static jp.mirai.framework.common.util.date.LocalDateTimeUtils.addTime;
